                        ...
                        <form method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="stage" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <?php foreach (LEAD_STAGES as $stage): ?>
                                        <option value="<?php echo esc($stage); ?>"><?php echo esc($stage); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="assigned_to" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        ...
                                        <option value="<?php echo $emp['id']; ?>"><?php echo esc($emp['name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="budget" step="100000" min="0"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                                <div>
                                    ...
                                    <select name="preferred_property_type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        ...
                                        <option value="<?php echo esc($key); ?>"><?php echo esc($type); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="source" placeholder="Website, Referral, etc."
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <a href="?page=leads" class="flex-1 text-center bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 rounded-lg transition">
                                    Cancel
                                </a>
                            </div>
                        </form>
